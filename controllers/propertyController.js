...
async function newProperty(req, res) {
    ...
    try {
        ...
        res.render('properties/new', { title: 'Add Property', errorMsg: '', ownerId: req.user._id.toString(), suburbs });
    } catch (err) {
        console.error(err);
        res.redirect('/');
    }
...
async function create(req, res) {
    ...
    try {
        ...
        console.log(err);
        res.render('properties/new', { errorMsg: err.message, title: 'Add New Property', ownerId: req.user._id.toString() });
    }
};
