...
async function show(req, res) {
    try {
        ...
        res.render('suburbs/show', { title: suburb.name , properties: suburb.properties, suburb });
    } catch (error) {
        console.log(error);
        res.redirect('/');
    }
...
async function newSuburb(req, res) {
    ...
    try {
        ...
        res.render('suburbs/new', { title: 'Add Suburb', errorMsg: '', ownerId: req.user._id.toString(), suburbs });
    } catch (err) {
        console.error(err);
        res.redirect('/');
    }
...
async function create(req, res) {
    ...
    try {
        ...
        console.log(err);
        res.render('suburbs/new', { errorMsg: err.message, title: 'Add New Suburb', ownerId: req.user._id.toString() });
    }
};
